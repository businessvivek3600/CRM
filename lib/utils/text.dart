            ...
            style: GoogleFonts.ubuntu(
              textStyle: style ??
                  getTheme(context).textTheme.bodySmall!.copyWith(
                      ...
                      color: (color ??
                          getTheme(context).textTheme.bodySmall!.color),
                      fontSize: fontSize,
                      height: lineHeight,
                      fontFamily:
                          getTheme(context).textTheme.bodySmall?.fontFamily,
            ...
            style: GoogleFonts.ubuntu(
              textStyle: style ??
                  getTheme(context).textTheme.bodyLarge!.copyWith(
                      ...
                      height: lineHeight,
                      fontFamily:
                          getTheme(context).textTheme.bodyLarge?.fontFamily,
                      decoration: decoration)
                ..color?.withOpacity(opacity),
            ),
          )
            ...
            style: GoogleFonts.ubuntu(
              textStyle: style ??
                  getTheme(context).textTheme.titleLarge!.copyWith(
                      ...
                      height: lineHeight,
                      fontFamily:
                          getTheme(context).textTheme.titleLarge?.fontFamily,
                      decoration: decoration)
                ..color?.withOpacity(opacity),
            ),
          )
...
extension StringToDouble on String? {
  double getDouble({double defaultValue = 0.0, int fraction = 2}) {
    return (double.tryParse(this ?? '0.0') ?? defaultValue)
        .toStringAsFixed(fraction)
        .toDouble();
  }
}

void launchThUrl(String? url) async {
