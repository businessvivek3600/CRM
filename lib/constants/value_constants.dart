...
///about section start ->
const NEWS = 'NEWS';
const DashboardTemplete = 'DashboardTemplete';
const WELCOME_OFFER = 'WELCOME_OFFER';
const GRIVENCE_TYPE = 'GRIVENCE_TYPE';
const MIN_CART_AMOUNT = 'MIN_CART_AMOUNT';
const DOWNLOADS_PDFS = 'DOWNLOADS_PDFS';
const ABOUT_US = "ABOUT_US";
const INFORMATION = "INFORMATION";
const SCHEDULE_CATEGORIES = "SCHEDULE_CATEGORIES";
const EVENT_CATEGORIES = "EVENT_CATEGORIES";
const CHAIRMAN_MESSAGE = "CHAIRMAN_MESSAGE";
const OUR_MISSION_VISION = "OUR_MISSION_VISION";
const MANAGEMENT = "OUR_MANAGEMENT";
const FINANCIAL_DOC = "FINANCIAL_DOC";
const DESCLAIMER = "DESCLAIMER";
const SIGNUP_TERMS_AND_CONDITIONS = "SIGNUP_TERMS_AND_CONDITIONS";
...
const IS_LOGGED_IN_AS_GUEST = 'IS_LOGGED_IN_AS_GUEST';
...
const LAST_PASSWORD_CHANGE = 'LAST_PASSWORD_CHANGE';
const NEW_PASS_KEY = 'NEW_PASS_KEY';
const NEW_PASS_KEY_REQUESTED = 'NEW_PASS_KEY_REQUESTED';
const ADMIN = 'ADMIN';
const ROLE = 'ROLE';
const ACTIVE = 'ACTIVE';
const DEFAULT_LANGUAGE = 'DEFAULT_LANGUAGE';
const DIRECTION = 'DIRECTION';
const MEDIA_PATH_SLUG = 'MEDIA_PATH_SLUG';
const IS_NOT_STAFF = 'IS_NOT_STAFF';
...
const TWO_FACTOR_AUTH_CODE_REQUESTED = 'TWO_FACTOR_AUTH_CODE_REQUESTED';
const EMAIL_SIGNATURE = 'EMAIL_SIGNATURE';
const GOOGLE_AUTH_SECRET = 'GOOGLE_AUTH_SECRET';
const DEVICE_ID = 'DEVICE_ID';
const IS_LOGIN = 'IS_LOGIN';
const LOGIN_IP_ADDRESS = 'LOGIN_IP_ADDRESS';

const LOGIN_TIME = 'login_time';
const MLM_ENABLED = 'MLM_ENABLED';
...
const CAN_SHOW_WALKTHROUGH = 'CAN_SHOW_WALKTHROUGH';
